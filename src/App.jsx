...
return (
  <div style={{
    ...
    <div style={{ textAlign: "center", position: "relative", zIndex: 1, width: "100%", maxWidth: 420 }}>
      {/* Logo */}
      ...
      <div style={{ fontSize: 14, color: "#64748B", marginBottom: 32 }}>Academic Year 2025–26 · RBCET</div>

      {/* Card */}
      <div style={{
        background: "rgba(26, 34, 53, 0.9)", backdropFilter: "blur(20px)",
        ...
        <div style={{ fontSize: 13, color: "#64748B", marginBottom: 24, lineHeight: 1.6 }}>
          Sign in to track projects and collaborate with your team
        </div>
